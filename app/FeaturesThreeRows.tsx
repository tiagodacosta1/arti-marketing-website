...
export default function Features() {
    const featureSets = [
        ["Multi Symbol Library", "Full Customisation", "AI Sentence Builder", "Web & Mobile App", "Arti Home Tiles", "Friends & Family Accounts"],
        ["Fast Performance", "Secure Data", "Offline Mode", "Cloud Sync", "User-Friendly UI", "24/7 Support"],
        ["Dark Mode", "Multi-Language Support", "Custom Themes", "Keyboard Shortcuts", "Gesture Controls", "Accessibility Options"]
    ];

    return (
        <div className="overflow-hidden w-full py-10 bg-gray-100 space-y-10">
            ...
            {featureSets.map((features, i) => (
                <div key={i} className="relative w-full flex items-center justify-start overflow-hidden">
                    <motion.div
                        ...
                        initial={{ x: 0 }}
                        animate={{ x: "-50%" }}
                        transition={{ repeat: Infinity, ease: "linear", duration: 5 + i }}
                    >
